...
client = OpenAI(
  # TODO: Hide API key
  api_key='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'
)
...
prompt_response = client.chat.completions.create(
  ...
  messages=[
    {
      'role': 'user',
      'content': f'Construct a prompt for DALL-E to create a texture for a planet based on a playlist containing artists in the following genres: {genre_prompt_insert}.'
    }
  ]
)
...
image_url = texture_reponse.data[0].url
